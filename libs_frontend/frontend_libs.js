(function(){
  var ref$, gexport, gexport_module, getUrlParameters, sleep, once_available, once_available_fast, once_available_multiselect, once_body_available, on_url_change, on_url_change_not_from_history, to_camelcase_string, to_camelcase_dict, create_shadow_div, wrap_in_shadow, create_shadow_div_on_body, append_to_body_shadow, make_checkbox_clickable, make_togglebutton_clickable, out$ = typeof exports != 'undefined' && exports || this;
  ...
  */
  ...
  out$.make_checkbox_clickable = make_checkbox_clickable = function(checkbox){
    var label, container;
    if (checkbox == null) {
      return;
    }
    if (checkbox.shadowRoot == null) {
      return;
    }
  ...
  out$.make_togglebutton_clickable = make_togglebutton_clickable = function(checkbox){
    var container;
    if (checkbox == null) {
      return;
    }
